...
set shortmess=aoO
badd +1 app/controllers/main_controller.rb
badd +29 app/controllers/pusher_controller.rb
badd +1 Gemfile
badd +37 config/routes.rb
badd +1 lib/cryptor.rb
badd +1 app/controllers/save_controller.rb
badd +16 config/application.rb
badd +22 public/js/LiveHelp.j
badd +27 app/views/layouts/application.html.erb
badd +33 public/js/Frameworks/Objective-J/Objective-J.js
badd +0 public/js/Ajax.j
...
exe 'vert 1resize ' . ((&columns * 57 + 113) / 227)
exe '2resize ' . ((&lines * 20 + 31) / 63)
exe 'vert 2resize ' . ((&columns * 169 + 113) / 227)
exe '3resize ' . ((&lines * 1 + 31) / 63)
exe 'vert 3resize ' . ((&columns * 58 + 113) / 227)
exe '4resize ' . ((&lines * 38 + 31) / 63)
exe 'vert 4resize ' . ((&columns * 58 + 113) / 227)
exe '5resize ' . ((&lines * 1 + 31) / 63)
exe 'vert 5resize ' . ((&columns * 168 + 113) / 227)
exe '6resize ' . ((&lines * 38 + 31) / 63)
exe 'vert 6resize ' . ((&columns * 168 + 113) / 227)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let s:l = 340 - ((5 * winheight(0) + 10) / 20)
...
setlocal errorformat=
setlocal expandtab
if &filetype != 'objective-j'
setlocal filetype=objective-j
endif
setlocal foldcolumn=0
setlocal foldenable
setlocal foldexpr=0
...
setlocal numberwidth=4
setlocal omnifunc=
setlocal path=.,~/AA_backup/aa_integr,~/AA_backup/aa_integr/app,~/AA_backup/aa_integr/app/models,~/AA_backup/aa_integr/app/controllers,~/AA_backup/aa_integr/app/helpers,~/AA_backup/aa_integr/config,~/AA_backup/aa_integr/lib,~/AA_backup/aa_integr/app/views,~/AA_backup/aa_integr/test,~/AA_backup/aa_integr/test/unit,~/AA_backup/aa_integr/test/functional,~/AA_backup/aa_integr/test/integration,~/AA_backup/aa_integr/app/*,~/AA_backup/aa_integr/vendor,~/AA_backup/aa_integr/vendor/plugins/*/lib,~/AA_backup/aa_integr/vendor/plugins/*/test,~/AA_backup/aa_integr/vendor/rails/*/lib,~/AA_backup/aa_integr/vendor/rails/*/test,/usr/include
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
...
setlocal swapfile
setlocal synmaxcol=3000
if &syntax != 'objective-j'
setlocal syntax=objective-j
endif
setlocal tabstop=2
setlocal tags=~/AA_backup/aa_integr/tmp/tags,./tags,./TAGS,tags,TAGS,~/AA_backup/aa_integr/tags
setlocal textwidth=0
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 181 - ((0 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
181
